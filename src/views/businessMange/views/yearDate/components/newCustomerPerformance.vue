<template>
    <Modal
        v-model="newCustomerPerformanceModels"
        title="新客业绩"
        :mask-closable="false"
...
export default {
    props:{
        newCustomerPerformanceModel:Boolean,
        newCustomerPerformanceList:Array,
        hospital:String,
        date:String,
    },
    components:{
    ...
    data(){
        return{
            newCustomerPerformanceModels:false,
            myChart: "",
        }
    },
    methods:{
        cancel(){
            this.$emit("update:newCustomerPerformanceModel", false);
        },
        // modal 显示状态发生变化时触发
    ...
    watch: {
        newCustomerPerformanceModel: {
            handler(value) {
                this.newCustomerPerformanceModels = value
            },
            deep: true,
        },
        newCustomerPerformanceList(value){
