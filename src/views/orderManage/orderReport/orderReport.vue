<template>
  <div>
    ...
    <Card class="list_item">
      ...
      <div class="list">
        <div
          class="item"
          @click="
            orderListReportModal = true;
            $refs.orderListReport.getsendOrderReport();
          "
        >
          <i
            class="iconfont icon-a-74wodedingdan frist_icons"
        ...
        <div
          class="item"
          @click="
            paymentOrderReportModal = true;
            $refs.paymentOrderReport.getpaymentOrderReport();
          "
        >
        ...
        <div
          class="item"
          @click="
            dispatchReportModal = true;
            $refs.dispatchReport.getsendOrderReport();
          "
        >
        ...
        <div
          class="item"
          @click="
            orderWriteOffModal = true;
            $refs.orderWriteOff.getOrderWriteOffReport();
          "
        >
        ...
        <div
          class="item"
          @click="
            refundOrderReportModal = true;
            $refs.refundOrderReport.getrefundOrderReport();
          "
        >
        ...
        <div
          class="item"
          @click="
            smallYellowCarRegistrationModel = true;
            $refs.smallYellowCarRegistrationReport.getshoppingCartRegistrationReport();
          "
        >
    ...
    <Card class="list_item">
      ...
      <div class="list">
        <div
          class="item"
          @click="
            hospitalOrderQuantityModel = true;
            $refs.hospitalOrderQuantity.gethospitalOrderQuantitys();
          "
        >
        ...
        <div
          class="item"
          @click="
            hospitalAppointmentsModel = true;
            $refs.hospitalAppointments.gethospitalAppointments();
          "
        >
    ...
    <Card class="list_item">
      ...
      <div class="list">
        ...
        <div
          class="item"
          @click="
            moneyReportModel2 = true;
            $refs.customerOrderReceivables2.getcustomerOrderReceivableReports();
          "
        >
        ...
        <div
          class="item"
          @click="
            customerUpgradeModel = true;
            $refs.customerUpgrade.getcustomerUpgrade();
          "
        >
        ...
        <div
          class="item"
          @click="
            anchorIPOperationReportModal = true;
            $refs.anchorIPOperationReport.getliveAnchorOperatingReport();
          "
        >
        ...
        <div
          class="item"
          @click="
            beatingAndCuttingGroupModel = true;
            $refs.beatingAndCuttingGroup.getbeatingAndCuttingGroup();
          "
        >
        ...
        <div
          class="item"
          @click="
            contentDealModal = true;
            $refs.contentPlatformTransactionReport.ContentPlatFormOrderDealReport();
          "
        >
        ...
        <div
          class="item"
          @click="
            transactionStatementModal = true;
            $refs.transactionStatement.transactionStatement();
          "
        >
    ...
    <Card class="list_item">
      ...
      <div class="list">
        ...
        <div
          class="item"
          @click="
            customerNoDispatchModel = true;
            $refs.customerNoDispatchReport.getCustomerServiceUnDispatch();
            $refs.customerNoDispatchReport.getCustomerServiceList();
          "
        >
          <i class="iconfont icon-order-incomplete frist_icons"></i>
          <div class="item_title">客服未派单报表</div>
        ...
        <div
          class="item"
          @click="
            customerServiceDispatchOrderModel = true;
            $refs.customerServiceDispatchOrderReport.getCustomerServiceDispatchedOrders();
            $refs.customerServiceDispatchOrderReport.getCustomerServiceList();
          "
        >
          <i class="iconfont icon-dingdanshenpi hos_icons2"></i>
          <div class="item_title">客服已派单报表</div>
    ...
    <!-- 订单核销报表 -->
    <orderWriteOff
      :orderWriteOffModal.sync="orderWriteOffModal"
      ref="orderWriteOff"
    ></orderWriteOff>
    <!-- 订单派单报表 -->
    <dispatchReport
      :dispatchReportModal.sync="dispatchReportModal"
      ref="dispatchReport"
    ></dispatchReport>
    <!-- 客户预约报表 -->
    <customerAppointmentCom
      :customerAppointmentModal.sync="customerAppointmentModal"
      ref="customerAppointmentCom"
    ></customerAppointmentCom>
    <!-- 客户订单应收款统计 -->
    ...
    <customerOrderReceivables2
      :moneyReportModel2.sync="moneyReportModel2"
      ref="customerOrderReceivables2"
    ...
    <hospitalOrderQuantity
      :hospitalOrderQuantityModel.sync="hospitalOrderQuantityModel"
      ref="hospitalOrderQuantity"
    ></hospitalOrderQuantity>
    <!-- 医院预约量报表 -->
    <hospitalAppointments
      :hospitalAppointmentsModel.sync="hospitalAppointmentsModel"
      ref="hospitalAppointments"
    ></hospitalAppointments>
    <!-- 客服订单报表 改 客服已派单报表 -->
    <customerServiceOrder
      :customerServiceOrderModel.sync="customerServiceOrderModel"
      ref="customerServiceOrder"
    ></customerServiceOrder>
    <!-- 客服未派单报表 -->
    <customerServiceUnDispatch
      :customerServiceUnDispatchModel.sync="customerServiceUnDispatchModel"
      ref="customerServiceUnDispatch"
    ></customerServiceUnDispatch>
    <!-- 可视化看板 -->
    <visualKanban
      :visualKanbanModel.sync="visualKanbanModel"
      ref="visualKanban"
    ></visualKanban>
    <!-- 客户升单报表 -->
    <customerUpgrade
      :customerUpgradeModel.sync="customerUpgradeModel"
      ref="customerUpgrade"
    ...
    <!--  订单派单2 -->
    <orderDispatch
      :orderDispatchModel.sync="orderDispatchModel"
      ref="orderDispatch"
    ></orderDispatch>
    <!-- 付款订单报表 -->
    <paymentOrderReport
      :paymentOrderReportModal.sync="paymentOrderReportModal"
      ref="paymentOrderReport"
    ></paymentOrderReport>
    <!-- 退款订单报表 -->
    <refundOrderReport
      :refundOrderReportModal.sync="refundOrderReportModal"
      ref="refundOrderReport"
    ></refundOrderReport>
    <!-- 主播IP运营报表 -->
    <anchorIPOperationReport
      :anchorIPOperationReportModal.sync="anchorIPOperationReportModal"
      ref="anchorIPOperationReport"
    ></anchorIPOperationReport>
    <!-- 内容平台成交报表 -->
    <contentPlatformTransactionReport
      :contentDealModal.sync="contentDealModal"
      ref="contentPlatformTransactionReport"
      :contentPalteForms.sync="contentPalteForms"
      :dealHospitalList="dealHospitalList"
    ></contentPlatformTransactionReport>
    <!-- 下单平台订单报表 -->
    <orderListReport
      :orderListReportModal.sync="orderListReportModal"
      ref="orderListReport"
    ></orderListReport>
    <!-- 客服未派单报表（下单平台、内容平台） -->
    <customerNoDispatchReport
      :customerNoDispatchModel.sync="customerNoDispatchModel"
      ref="customerNoDispatchReport"
    ></customerNoDispatchReport>
    <!-- 客服已派单报表（下单平台、内容平台） -->
    <customerServiceDispatchOrderReport
      :customerServiceDispatchOrderModel.sync="
        customerServiceDispatchOrderModel
      "
      ref="customerServiceDispatchOrderReport"
      :dispatchHospital="dispatchHospital"
    ></customerServiceDispatchOrderReport>
    <!-- 小黄车登记报表 -->
    <smallYellowCarRegistrationReport
      :smallYellowCarRegistrationModel.sync="smallYellowCarRegistrationModel"
    ...
    <transactionStatement
      :transactionStatementModal.sync="transactionStatementModal"
    ...
    <beatingAndCuttingGroup
      :beatingAndCuttingGroupModel.sync="beatingAndCuttingGroupModel"
      ref="beatingAndCuttingGroup"
      :contentPalteForms.sync="contentPalteForms"
    ></beatingAndCuttingGroup>
  </div>
</template>
    ...
    getcontentPlateFormOrderToHospitalTypeList() {
      api.contentPlateFormOrderToHospitalTypeList().then((res) => {
        if (res.code === 0) {
          ...
          this.transactionParams.toHospitalTypeList = [
            ...this.transactionParams.toHospitalTypeList,
            ...orderTypes,
          ];
        }
    ...
    getCustomerServiceList() {
      api.getCustomerServiceList().then((res) => {
        if (res.code === 0) {
          ...
          this.transactionParams.employee = [
            ...this.transactionParams.employee,
            ...employee,
          ];
        }
    ...
    getHospitalList() {
      api.getHospitalList().then((res) => {
        if (res.code === 0) {
          ...
          this.transactionParams.dealHospitalList = [
            ...this.transactionParams.dealHospitalList,
            ...hospitalInfo,
          ];
