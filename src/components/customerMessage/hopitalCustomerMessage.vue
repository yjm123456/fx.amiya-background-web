         ...
         <Card >
            <div>
                <div class="top_content">
                    ...
                    <div  class="top_right">派单客服：{{customerMessageObjs.belongCustomerService}}</div>
         ...
         <Card style="margin-top:10px">
            ...
            >
                <Row :gutter="30">
                    ...
                    <Col span="6">
                        <FormItem label="派单客服" prop="belongCustomerService">
                            <Input v-model="form.belongCustomerService" placeholder="请输入派单客服"  disabled></Input>
                        </FormItem>
                    </Col>
                    <Col span="6">
    ...
    handleSubmit(name) {
      ...
      api.updateById(data).then((res) => {
        if (res.code === 0) {
            ...
            this.$emit("hospitalGetCustomerList")
