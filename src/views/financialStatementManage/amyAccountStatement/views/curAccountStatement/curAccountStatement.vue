      ...
      <div class="content">
        <div class="left">
          ...
          <!-- <Button
            ...
            style="margin-left: 10px"
            v-if="
              employeeType == 'amiyaEmployee' && query.reconciliationState == 3
            "
            >回款</Button
          > -->
      ...
      <div class="page_wrap">
        <div class="bottom_title">
          <span class="bottom_right">
            <span class="title_00">信息服务费合计：</span> 
            <span style="color:red;font-weight:bold">{{
              returnBackPriceNum == 0 ? 0 : returnBackPriceNum.toFixed(2)
            }}</span></span
          >
          <span class="bottom_right">
            <span  class="title_00">系统维护费合计：</span>
            <span style="color:red;font-weight:bold">{{
              systemUpdatePriceNum == 0 ? 0 : systemUpdatePriceNum.toFixed(2)
            }}</span></span
          >
          <span class="bottom_right">
            <span  class="title_00">服务费合计：</span>
            <span style="color:red;font-weight:bold">{{
              collectionNum == 0 ? 0 : collectionNum.toFixed(2)
            }}</span></span
          >
          <span class="bottom_right">
            <span  class="title_00">对账业绩合计：</span>
            <span style="color:red;font-weight:bold">{{
              reconciliationPerformanceNum == 0 ? 0 : reconciliationPerformanceNum.toFixed(2)
            }}</span></span
          >
        </div>
        <Page
...
export default {
  ...
  methods: {
    ...
    invoiceClick() {
      ...
      //   // console.log(invoiceList[index].hospitalId ,index , invoiceList[index-1].hospitalId)
      //   if(index > 0){
      //     if(invoiceList[index].hospitalId != invoiceList[index-1].hospitalId){
      ...
      //     }
      //   }
      //   if (item.isCreateBill == true) {
      //     this.$Message.warning("您选中的对账单存在已开票数据，请认真核对后重试！");
      //     return;
      //   }
      //   hospitalId.push(item.hospitalId)
      // })
    ...
    exportChange() {
      ...
      const data = {
        ...
        hospitalId:
          this.employeeType == "hospitalEmployee"
