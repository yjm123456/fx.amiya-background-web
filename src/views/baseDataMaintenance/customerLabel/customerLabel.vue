  ...
  <div>
    ...
    >
      ...
      >
        ...
        <FormItem label="标签分类" prop="tagCategory">
          <Select
          ...
          >
            <Option
              v-for="item in tagCategoryNameList"
              :value="item.id"
              :key="item.id"
              >{{ item.name }}</Option
            >
                      ...
                      click: () => {
                        ...
                        api.byIdCustomerTagInfo(id).then((res) => {
                          if (res.code === 0) {
                            ...
                            this.form.tagCategory = tagCategory
                            this.form.id = id;
      ...
      this.$refs[name].validate((valid) => {
        if (valid) {
          if (this.isEdit) {
            ...
            const { tagName, tagCategory } = this.form;
            const data = { tagName, tagCategory:Number(tagCategory) };
            // 添加
