            ...
            <Card class="content">
                    ...
                    <!-- <div class="left_customer">
                        ...
                        <div  class="r_content4">
                            <span class="r_t2" style="margin-top:12%"><span class="num">{{funnelObj.newCustomerData.addWeChatToDealPrice}}</span>元</span>
                        </div>
                        <div  class="r_content5">
                            <span class="r_t2" style="margin-top:12%"><span class="num">{{funnelObj.newCustomerData.sendOrderToDealPrice}}</span>元</span>
                        </div>
                        <div  class="r_content5">
                            <span class="r_t2" style="margin-top:12%"><span class="num">{{funnelObj.newCustomerData.visitToDealPrice}}</span>元</span>
                        </div>
                        <div  class="r_content5">
                    ...
                    <div class="new_customer">
                        <div class="center_data">
                            <div  class="c_text"><span style="padding-left:30px">/</span> <span class="num"></span> </div>
                            <div  class="c_text"><span style="padding-left:30px">/</span> <span class="num"></span> </div>
                            <div  class="c_text"><span>{{funnelObj.newCustomerData.newCustomerOperationDataDetails[0].name}}</span> <span class="num">{{funnelObj.newCustomerData.newCustomerOperationDataDetails[0].value}}</span>人</div>
                        ...
                        <div class="right_data">
                            ...
                            <div  class="r_content2">
                                <span class="r_t2" >加v率：<span class="num" :style="{color:funnelObj.newCustomerData.addWeChatRate < funnelObj.newCustomerData.addWeChatRateHealthValueThisMonth ? 'red' : '#2f8cf0'}"></span>/</span>
                                <span  class="r_t3"><span class="num"></span>/</span>
                            </div>
                            <div  class="r_content3">
                                <span class="r_t2" style="margin-top:14%">派单率：<span class="num" :style="{color:funnelObj.newCustomerData.sendOrderRate < funnelObj.newCustomerData.sendOrderRateHealthValueThisMonth ? 'red' : '#2f8cf0'}"></span>/</span>
                                <span  class="r_t3" style="margin-top:14%"><span class="num"></span>/</span>
                            </div>
                            <div  class="r_content4">
