...
export default {
    props:{
        oldPerformanceModel:Boolean,
        oldPerformanceList:Array
    },
    components:{
    ...
    data(){
        return{
            oldPerformanceModels:false,
            myChart: "",
        }
    },
    methods:{
        cancel(){
            this.$emit("update:oldPerformanceModel", false);
        },
        // modal 显示状态发生变化时触发
    ...
    watch: {
        oldPerformanceModel: {
            handler(value) {
                this.oldPerformanceModels = value
            },
            deep: true,
        },
        oldPerformanceList(value){
