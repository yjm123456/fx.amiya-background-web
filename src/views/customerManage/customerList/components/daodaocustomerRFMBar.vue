<template>
  <div class="wrapper">
    <div class="content">
      <Card class="left"> 
        <div class="num_text">总人数：{{numAll}}</div>
        <div class="text_con" >
...
export default {
  ...
  methods: {
    ...
    myEcharts(value) {
      ...
      let option = {
        tooltip: {
          ...
          //                   <div>
          //                       <i class="dot" style="background: ${params[0].color};display: inline-block;width: 8px; height: 8px;border-radius: 50%;"></i>
          //                         <span> 较昨天: ${params[2].value}</span>
          //                     </div>
          //                 </div>
          //                 <div class="flex justify-content-space-between">
          //                   <div>
          //                       <i class="dot" style="background: ${params[0].color};display: inline-block;width: 8px; height: 8px;border-radius: 50%;"></i>
          //                         <span> 客户数量: ${params[1].value}</span>
          //                     </div>
          //                 </div>
          //               </div>`
          // },
    ...
    myDialog(value){
      this.detail = value 
      if(this.active == 'daodaocustomerRFMBar'){
    ...
    getDetail(value){
      ...
      const data = {
        rfmType:value,
        liveAnchorBaseId:this.liveAnchorBaseInfos.find(item=>item.name == '刀刀').id,
        employeeId:null,
        startDate:'',
        endDate:'',
        keyWord:'',
