    ...
    <Card class="container">
      ...
      <div class="page_wrap">
        <div class="bottom_title">
          ...
          >
          <span class="bottom_right">
            <span class="title_00">合计稽查业绩：</span>
            <span style="color:red;font-weight:bold">{{
              inspectPrice == 0 ? 0 : inspectPrice.toFixed(2)
            }}</span>
          </span>
        </div>
      </div>
...
export default {
        ...
        columns: [
          ...
          },
          {
            ...
            render: (h, params) => {
              return h(
                "div",
                params.row.inspectCustomerServiceCompensationId
                  ? "已生成薪资单"
                  : "未生成薪资单"
              );
            },
  ...
  methods: {
    handleSelect(selection, row) {
      ...
      // 稽查业绩合计
      this.inspectPrice += row.inspectPrice;
    },
    handleCancels(selection, row) {
      ...
      // 稽查业绩合计
      this.inspectPrice = this.inspectPrice - row.inspectPrice;
    },
    ...
    handleSelectAll(selection) {
      if (selection && selection.length === 0) {
        ...
        selection.forEach((item) => {
          ...
          // 稽查业绩合计
          this.inspectPrice += item.inspectPrice;
        });
      }
    },
    // 获取薪资审核表
