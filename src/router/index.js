...
const businessMange = [{
    ...
    {
        path: "/administrationKanBan",
        name: "administrationKanBan",
        meta: {
            title: "行政客服看板",
            keepAlive: false,
            isTag: true,
        ...
        component: () =>
            import ("@/views/businessMange/administrationKanBan/administrationKanBan.vue"),
    },
    {
        path: "/beforeLiveStreamingKanBan",
        name: "beforeLiveStreamingKanBan",
        meta: {
            title: "直播前看板",
            keepAlive: false,
            isTag: true,
        ...
        component: () =>
            import ("@/views/businessMange/beforeLiveStreamingKanBan/beforeLiveStreamingKanBan.vue"),
    },
    {
        path: "/liveStreamingKanBan",
        name: "liveStreamingKanBan",
        meta: {
            title: "直播中看板",
            keepAlive: false,
            isTag: true,
    ...
    },
    {
        ...
        component: () =>
            import ("@/views/businessMange/hospitalKanBan/hospitalKanBan.vue"),
    }
];
